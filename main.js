...
Element_of_array = quick_draw_data_set[randomnumber]
timecounter = 20
scorecounter = 0
timercheck = ""
drawsketch = ""
answerholder = "set"
document.getElementById("sketchthis").innerHTML = "Sketch this: " + Element_of_array
function draw()
{
    check_sketch()
    if(drawsketch == Element_of_array)
    {
        answerholder = "set"
        score++
        document.getElementById("quickscore").innerHTML = score
    }
}
function check_sketch()
{
    timecounter++
    document.getElementById("quicktimer").innerHTML = timecounter
    if(timecounter > 399)
    {
        timecounter = 0
